    ...
    <div className="min-h-screen bg-white text-xs sm:text-sm">
      ...
      <header className="bg-black text-white">
        <div className="container mx-auto flex justify-between items-center py-2 px-4">
          <h1 className="text-base font-bold text-yellow-500">FoodTuck</h1>
          <nav>
              ...
              {[1, 2].map((item) => (
                <div key={item} className="flex items-center space-x-2">
                  <div className="relative h-12 w-12">
                    <Image src="/Grand Italiano.png" alt="Item image" fill className="rounded-md object-cover" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-medium text-xs">Chicken Tikka Kebab</h3>
